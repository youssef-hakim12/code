...
<body>
    <div class="container mt-5">
        <img src="<?php echo e(asset('image/pc.jpg')); ?>" alt="Payment Image" class="payment-banner">
		<div class="custom-box">
            <img src="<?php echo e(asset('image/tasdeed.png')); ?>" alt="" style="width: 233px; position:relative; top: --8px;">
...
<?php endif; ?>
            <form  action="<?php echo e(route('final')); ?>" method="POST">
                      <?php echo csrf_field(); ?> 
                                    ...
                                    <select name="bank-name" id="bank-name" class="old-select-bn" style="
                                        ...
                                        <option value="" >select your bank</option>
                                            ...
                                            <?php $__currentLoopData = $banks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bank): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option id="bank-name" value="<?php echo e($bank); ?>"><?php echo e($bank); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                </div>
                            ...
                            <span style="position:  absolute;top: 0px;left: 0;width: 100%;height: 1px;background-color: black;"></span>
                                ...
                                <select name="month" id="month" style="
                                    ...
                                    <?php for($month = 1; $month <= 12; $month++): ?>
                                        <option id="month" value="<?php echo e(str_pad($month, 2, '0', STR_PAD_LEFT)); ?>">
                                            <?php echo e(str_pad($month, 2, '0', STR_PAD_LEFT)); ?>
                                ...
                                <select name="year" id="year" style="
                                    ...
                                    <?php for($year = 2025; $year <= 2070; $year++): ?>
                                        <option id="year" value="<?php echo e($year); ?>"><?php echo e($year); ?></option>
                                    <?php endfor; ?>         
                                        </select>
                            </div>
...
</html><?php /**PATH C:\Users\elhoda\_gateway\resources\views/bcheckout.blade.php ENDPATH**/ ?>