...
<body>
    <div class="container mt-5">
		...
		<div class="custom-box">
			<img src="<?php echo e(asset('image/tasdeed.png')); ?>" alt="" style="width: 270px; position:relative; top: -19px;">
            ...
            <div class="billing-title" style="margin-top: 15px;">Card Information</div>
                ...
                ?>
                    ...
                    <span style="font-size: 15px;
                        font-weight: bold;
                        position: relative;
                        color: #454e5f;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($firstSix); ?>*****<?php echo e($lastFour); ?></span>
                ...
                <div class="billing-row">
                    ...
                    <span style="font-size: 15px;
                        font-weight: bold;
                        position: relative;
                        color: #454e5f">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($form['month']); ?></span>
                </div>
                <div class="billing-row">
                    ...
                    <span style="font-size: 15px;
                        font-weight: bold;
                        position: relative;
                        color: #454e5f">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($form['year']); ?></span>
                </div>
                <div class="billing-row">
            ...
            <a href="<?php echo e(route('bcheckout')); ?>" 
                style="display: inline-block; text-align: center; line-height: 30px; width: 113px; height: 30px; color:#1d1c1cd5; background-color: #e6e6e6; border: 1px solid #999; font-family: Arial, sans-serif; font-size: 14px; font-weight: bold; text-decoration: none; cursor: pointer;">
                Back
            </a>
...
</html><?php /**PATH C:\Users\elhoda\_gateway\resources\views/fcheckout.blade.php ENDPATH**/ ?>